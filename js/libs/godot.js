...
var Godot = (() => {
    ...
    return async function (moduleArg = {}) {
            ...
            if (currentNodeVersion < 2147483647) {
                throw new Error(
                    `This emscripten-generated code requires node v${packedVersionToHumanReadable(
                        2147483647
                    )} (detected v${packedVersionToHumanReadable(
                        currentNodeVersion
                    )})`
                );
            }
        ...
        function findWasmBinary() {
            return locateFile(
                "godot.web.template_release.wasm32.nothreads.minigame.wasm"
            );
        }
        ...
        var FS_preloadFile = async (
            ...
            try {
                ...
                byteArray = await FS_handledByPreloadPlugin(
                    byteArray,
                    fullname
                );
                preFinish?.();
        ...
        var FS = {
            ...
            statfs(path) {
                return FS.statfsNode(
                    FS.lookupPath(path, { follow: true }).node
                );
            },
            statfsStream(stream) {
            ...
            statfsNode(node) {
                ...
                if (node.node_ops.statfs) {
                    Object.assign(
                        rtn,
                        node.node_ops.statfs(node.mount.opts.root)
                    );
                }
                return rtn;
            },
            ...
            SampleNode: class SampleNode {
                ...
                getPositionWorklet() {
                    ...
                    let scriptProcessorNode =
                        GodotAudio.ctx.createScriptProcessor(2048, 2, 2);
                    positionWorker.postMessage({
                        type: "init",
                        currentTime: GodotAudio.ctx.currentTime,
                    });
                ...
                clear() {
                    ...
                    if (this._positionWorklet) {
                        ...
                        GodotAudio.audioPositionWorkletNodes.push(
        ...
        function _godot_js_display_cursor_set_custom_shape(
            ...
            if (p_len > 0) {
                ...
                const url = window.URL.createObjectURL(png);
        ...
        function _godot_js_display_window_icon_set(p_ptr, p_len) {
            ...
            // 		console.log('[DEBUG] parent:', document.body, 'child:', link);
            // 		document.head.appendChild(link);
            // 	}
            // 	const png = new Blob([GodotRuntime.heapSlice(HEAPU8, p_ptr, p_len)], {
            // 		type: "image/png",
            // 	});
            // 	// GodotDisplay.window_icon = window.URL.createObjectURL(png);
            ...
            // }
            // if (old_icon) {
            // 	window.URL.revokeObjectURL(old_icon);
            // }
        }
        ...
        function _godot_js_emscripten_get_version() {
            const emscriptenVersionPtr = GodotRuntime.allocString("4.0.16");
        ...
        function _godot_js_os_download_buffer(p_ptr, p_size, p_name, p_mime) {
            ...
            console.log("[DEBUG] parent:", document.body, "child:", a);
        ...
        var __emscripten_timeout = makeInvalidEarlyAccess(
        ...
        function assignWasmExports(wasmExports) {
            ...
            __emscripten_timeout = createExportWrapper(
                "_emscripten_timeout",
                2
            );
        ...
        var wasmImports = {
            ...
            godot_audio_sample_register_stream:
                _godot_audio_sample_register_stream,
            ...
            godot_js_display_canvas_is_focused:
            ...
            godot_js_display_cursor_is_hidden:
                _godot_js_display_cursor_is_hidden,
            godot_js_display_cursor_is_locked:
            ...
            godot_js_display_desired_size_set:
            ...
            godot_js_display_is_swap_ok_cancel:
            ...
            godot_js_display_window_title_set:
            ...
            godot_js_webmidi_open_midi_inputs:
                _godot_js_webmidi_open_midi_inputs,
            godot_js_websocket_buffered_amount:
            ...
            godot_js_wrapper_object_is_buffer:
                _godot_js_wrapper_object_is_buffer,
            ...
            instantiateWasm: function (imports, onSuccess) {
                ...
                if (typeof WebAssembly.instantiateStreaming !== "undefined") {
                    ...
                    if (r instanceof ArrayBuffer) {
                        console.log("[godot] WebAssembly.instantiate");
